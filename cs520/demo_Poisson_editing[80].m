...
solveMethods = {'Jacobi', 'Gauss-Seidel', 'Matlab Sparse Solver', 'SOR', 'Multi-grid', 'FFT'};
...
methodNum = input( sprintf('   enter the index to the methods [1, 2, 3] = ', length(solveMethods) ) );
...
switch methodNum
    ...
    case 2
        r = mixedDivG;
        [Iedited, residual, iterStep] = ...
            poissonSolverGauss( I, msktgt, mixedDivG, ...
                                        maxIter, tauDiff );
    otherwise
